...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "McGregor-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.mcgregorproject.com",  ""};
static const string testnet_seeds[] = {"", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("5.231.205.133", 18888), true);
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.fUseTestNet) {
    /*
    change the magic number to match that in chainparams.cpp
    */
